...
约年与争议沿用源数据采用端点，覆盖百分比不将其升级为精确事实。跨政权汇总按“政权年”累计，不是全球不重复年份。原先 `available` 仍仅表示至少有可展示记录；两种指标不能混称。细节、首批五个候选的处理和修改前后区间见 [年份覆盖审查](temporal-coverage-review.md)。
...
分期地理进展（2026-09-08，P1）：前燕补棘城337—342与邺城357—370后达到34/34政权年；西秦按勇士城、金城、苑川、度坚山、谭郊、枹罕和南安拆分后覆盖两段39/39政权年，401—408中断期没有点位。南明补桂林1647、南宁1649—1651、安龙1652—1656、昆明1656—1659，达到15/19，保留1648及1660—1662流动、流亡与拘押阶段缺口。神圣罗马帝国只新增1663—1806年永久帝国议会驻雷根斯堡的 `political-center`，不把它写成固定皇都；1025—1662年的巡回宫廷与多中心结构继续保留缺口。具体取舍与来源见[第二批分期地图点位审查](temporal-geography-p1-review.md)。

地理证据与年份进展（2026-09-10，P0/P1）：第二批闭环大城、素可泰、吴哥、蒲甘、法泰赫普尔西格里、撒马尔罕、开京、江华、君士坦丁堡、布尔萨、开罗、阿克苏姆、大津巴布韦、特诺奇蒂特兰、库斯科和特奥蒂瓦坎16条既有点位；每条分别定位机构/学术史料与具体 OSM 对象。新增隋581—582年长安旧城、唐904—907年洛阳和元1271—1364年上都，隋、唐、元地理年份覆盖达到100%；南宋、南明与花剌子模的流动阶段继续保留未知。当前194条点位中119条至少有一项定位，49条全部引用已定位、70条部分定位、75条完全缺少定位。详见[第二批地理点位证据审查](geography-evidence-p2.md)。

全记录来源定位进展（2026-09-15，P0）：12个核心实体、拜占庭与高丽的130位人物和133条任期，以及8条跨地区点位完成定位。无定位实体、人物、任期和点位分别降至102、1067、1103和67条；地理记录现有57条全部引用定位、70条部分定位。证据不足的点位年份保持未知；详见[第一批全记录来源定位](source-evidence-p0.md)。

第二批来源定位进展（2026-09-15，P0）：再闭环巴格达、尼西亚、德里、贡德尔、埃迪尔内、大不里士、加兹温与哈兰，并补齐刘宋、南齐、梁、陈四条建康点位的坐标引用。无定位点位降至59条，部分定位降至66条，全部引用定位增至69条；门禁开始同时约束无定位与部分定位数量。巴格达排除836—892年萨迈拉首都期，贡德尔起点改为1636年，尼西亚延至1261年，德里改为代表性中心；详见[第二批来源定位](source-evidence-p0-2.md)。

第三批来源定位进展（2026-09-16，P0）：补齐洛阳3条、开封4条、成都3条与姑臧2条点位的具体OSM坐标对象，不改变历史身份、角色或适用期。部分定位点位由66降至54，全部引用定位由69增至81；详见[第三批来源定位](source-evidence-p0-3.md)。

第四批来源定位与误配纠正（2026-09-23，P0）：东吴武昌改用今鄂州现代城市级坐标，补入孙权迁建业年和孙皓复都段，并披露266/267年终年口径差异；无定位点位由59降至58。拜占庭与高丽共263条人物及任期引用改用具名王表条目，防止同页通用定位文本掩盖不可复核的引用；详见[第四批来源定位](source-evidence-p0-4.md)。

萨迈拉分期点位（2026-09-23，P1）：按 UNESCO 遗产说明补入阿拔斯哈里发836—892年萨迈拉第二都城点位，并采用遗产地中心区登记坐标作近似区域锚点。巴格达点位继续排除该段，750—761年仍为未知；阿拔斯地理年份覆盖由440/509增至497/509，详见[萨迈拉分期点位审查](temporal-geography-p2-review.md)。
