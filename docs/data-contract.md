...
当前数据已为数据集内全部 71 个中国政权和拜占庭、阿拔斯、神圣罗马、朱罗 4 个世界代表政权接入统治者详情，共收录 675 位人物和 706 条任期记录，其中世界条目包含 205 位人物和 236 条任期。收录范围以正式统治者为主，并包括有来源支持的重要摄政者、共治者和主要争位者。早期王年只录入可明确披露史学口径的记录，其余年份保留为“资料尚未校订”。其他地区仍可在不破坏实体模型的前提下增量补充；当前四个世界条目不代表其所在地区的完整通史覆盖。
