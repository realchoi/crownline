...
- `.generated/data/coverage-report.json`：确定性的机器可读覆盖报告，记录全局及顶层历史地区的政权数、统治者详情、本地名称、地图和关系覆盖，以及对应缺口 ID，不进入生产包。
...
当前数据集共包含 133 个实体、1335 位人物、1374 条任期、18 条结构化关系、14 条事件、126 条地理快照、166 项来源和 133 个详情包；其中中国全览仍保持 73 条时间轴记录、7 个历史阶段，71 个中国政权与 58 个世界政权已接入统治者任期。地图覆盖 60 个世界样本与 26 个中国代表政权，十一个顶层历史地区均有可显示点位；点位不代表疆域。中国之外的东亚当前收录统一新罗、高丽、朝鲜王朝、足利幕府、德川幕府与琉球王国；南亚在原有样本外新增毗奢耶那伽罗帝国与马拉塔帝国；中亚收录贵霜帝国、萨曼帝国、西辽（喀喇契丹）、花剌子模帝国与帖木儿帝国；东非收录库施王国、阿克苏姆王国、基尔瓦苏丹国与埃塞俄比亚帝国；南部非洲收录大津巴布韦王国、穆塔帕帝国、祖鲁王国与北恩德贝莱王国；美洲新增奇穆帝国与普雷佩查帝国，北非新增努米底亚王国与穆瓦希德哈里发国。除正式统治者外，还按来源收录重要摄政者、共治者和主要争位者。大津巴布韦王国与特奥蒂瓦坎目前没有可展示的统治序列，继续明确显示为“资料尚未校订”；其他早期王年也只录入可明确标注口径的代表记录。只有 `reignVacancies` 中存在有来源记录时才显示“空位”，避免从数据缺口推导历史事实。结构化关系覆盖七种类型，所有关系和事件来源均带章节、页码或页面定位；朝贡、臣属、贸易和文化交流均附限制性口径，不从数据缺口或时间重叠推断关系。
