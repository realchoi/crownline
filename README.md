...
- 71 个中国政权已接入统治者任期；时间点详情可显示在位、共治、摄政、争位、明确空位与资料缺口
...
统治者数据当前覆盖数据集内全部 71 个中国政权，共收录 470 位人物与 470 条任期；除正式统治者外，还按来源收录重要摄政者、共治者和主要争位者。早期王年只录入可明确标注口径的代表记录，缺少任期的年份显示为“资料尚未校订”。只有 `reignVacancies` 中存在有来源记录时才显示“空位”，避免从数据缺口推导历史事实。
...
长远规划见 [ROADMAP.md](ROADMAP.md)。阶段 3 已从 16 个主线政权扩展到数据集内全部 71 个中国政权，共接入 470 位人物与 470 条任期；阶段 2B 的中国、自选地区与全球已收录三种范围继续共享全览和时间点状态，多地区全览按地区及跨地区政权分组，并在当前可见结果间使用统一时间比例。
