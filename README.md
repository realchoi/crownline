...
- 支持时间轴与离线历史示意地图切换；地图默认汇集所有已校订政权点位，拖动年份轴后按当前年份筛选，并与地区、搜索、详情和双政权对比共享状态。现有地理数据覆盖 60 个世界样本与 44 个中国代表政权的 146 条有来源点位；点位只表示都城、政治中心或浏览定位，不代表完整疆域。
...
- 71 个中国政权与 58 个世界政权已接入统治者任期；当前数据集累计 133 个实体、1335 位人物、1374 条任期、28 条关系、18 条事件、146 条地理快照、8 条疆域快照与 187 项来源，数据契约为 v5。关系案例已覆盖 11 个顶层地区；大津巴布韦王国与特奥蒂瓦坎的正式审查结论见 [统治者资料缺口审查](docs/ruler-gap-review.md)。
