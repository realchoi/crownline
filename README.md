...
- 自选地区与全球已收录全览按地区局部尺度展示完整年代范围，跨地区政权单独分组且只显示一次
...
长远规划见 [ROADMAP.md](ROADMAP.md)。阶段 2B 已让中国、自选地区与全球已收录三种范围共享全览和时间点状态；中国继续使用历史阶段局部尺度，多地区全览则按地区及跨地区政权分组，并让地区与年份、搜索、类别和 URL 状态组合生效。
